 ...
 * Simple utility to upload images and return URL for database storage
 * @author buimi
 */
public class CloudinaryUploadUtil {
    ...
    /**
     * Upload image from servlet Part and return URL for database
     * Usage: String imageUrl = CloudinaryUploadUtil.uploadImage(request.getPart("businessLicense"), "business-licenses");
     * 
     * @param part Image file from form upload
     * @param folderName Folder name in Cloudinary (e.g., "business-licenses", "avatars", "job-images")
    ...
    /**
     * Upload image from File object and return URL for database
     * Usage: String imageUrl = CloudinaryUploadUtil.uploadImage(new File("path/to/image.jpg"), "products");
     * 
    ...
    /**
     * Upload image with custom public ID and return URL
     * Useful when you want to control the image name
     * 
     * @param part Image file from form upload
     * @param folderName Folder name in Cloudinary
