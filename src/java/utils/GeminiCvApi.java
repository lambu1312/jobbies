...
public class GeminiCvApi {
    ...
    private static final String API_KEY = "AIzaSyDlUi2KQWLyNiSUYU4fg7X_DBT-s7eclHQ";
        ...
        for (String model : MODELS) {
            ...
            for (int attempt = 1; attempt <= MAX_RETRY; attempt++) {
                try {
                    ...
                    try { Thread.sleep(300L * attempt * attempt); } catch (InterruptedException ignored) {}
                }
            }
        }
