...
///
    ...
    public List<JobPostings> findJobPostingsWithAllFilters(
        String searchJP, String filterCategory,
        String filterJobType, String filterLocation,
    ...
    if (searchJP != null && !searchJP.isEmpty()) {
        sql += " AND Title LIKE ? ";
        parameterMap.put("Title", "%" + searchJP + "%");
    }
    if (filterCategory != null && !filterCategory.isEmpty()) {
    ...
    if (filterJobType != null && !filterJobType.isEmpty()) {
        sql += " AND JobTypeID = ? ";
        parameterMap.put("JobTypeID", filterJobType);
    }
    if (filterLocation != null && !filterLocation.isEmpty()) {
        sql += " AND WorkLocationID = ? ";
        parameterMap.put("WorkLocationID", filterLocation);
    }
    if (filterDeadline != null && !filterDeadline.isEmpty()) {
        sql += " AND DeadlineID = ? ";
        parameterMap.put("DeadlineID", filterDeadline);
    }
...
public int countJobPostingsWithAllFilters(
        String searchJP, String filterCategory,
        String filterJobType, String filterLocation,
        String filterDeadline) {
