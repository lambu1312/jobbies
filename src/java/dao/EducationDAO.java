...
public class EducationDAO extends GenericDAO<Education> {
    ...
    public int insert(Education t) {
        String sql = "INSERT INTO Education(CandidateID, Institution, Degree, FieldOfStudy, StartDate, EndDate, DegreeImg) values \n"
                + "  (?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<Education> findEducationbyCandidateID(int CandidateID) {
        String sql = "select * from Education where CandidateID = ?";
        parameterMap = new LinkedHashMap<>();
