                            ...
                            <div>
                                ...
                                <select name="filterCategory" class="form-select">
                                    ...
                                    <c:forEach var="category" items="${activeCategories}">
                                        <option value="${category.getId()}" ${category.getId()==param.filterCategory
                                                         ? 'selected' : '' }>
                                                    ${category.getName()}
                                                </option>
                                        </c:forEach>
                                    ...
                                    <div class="filter-grid" style="margin-top: 1rem;">
                                        ...
                                        <div style="display: flex; align-items: flex-end;">
                                            <label class="filter-checkbox">
                                                ...
                                                <input type="checkbox" name="onlineOnly" value="true" ${param.onlineOnly=='true'
                                                                                                        ? 'checked' : '' }>
                                            </label>
                                        </div>
