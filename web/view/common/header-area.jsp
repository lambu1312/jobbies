        ...
        <div class="nav-links" id="navLinks">
            ...
            <c:choose>
                <c:when test="${empty sessionScope.account}">
                    <button class="cta-button" onclick="window.location.href='${pageContext.request.contextPath}/authen'">
                        Đăng nhập / Đăng ký
                    </button>
                </c:when>
                <c:otherwise>
                    <div class="user-dropdown">
                        ...
                        <div class="dropdown-menu" id="userDropdownMenu">
                            <a href="${pageContext.request.contextPath}/jobPost" class="dropdown-item">
