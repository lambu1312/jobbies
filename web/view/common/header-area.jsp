        ...
        <div class="d-flex align-items-center justify-content-between py-3">
            ...
            <style>
                ...
                .logo-title {
                    ...
                    color: #6c2fff;
                    letter-spacing: 1px;
                    text-shadow: 0 2px 8px rgba(108,47,255,0.25);
                    transition: .3s;
                }
                ...
                .logo-brand:hover .logo-title {
                    ...
                    text-shadow: 0 4px 15px rgba(108,47,255,0.45);
                }
                .logo-brand:hover .logo-icon {
                    transform: scale(1.05);
                    box-shadow: 0 4px 18px rgba(138, 0, 255, .5);
                }
            </style>
            ...
            <div class="rts__menu d-flex gap-4 align-items-center">
                <div class="navigation d-none d-lg-block">
                    <nav class="navigation__menu" id="offcanvas__menu">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-bold" href="${pageContext.request.contextPath}/HomeSeeker">Công Việc</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-bold" href="#">Tạo CV</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-bold" href="#">Trang Thái Ứng Tuyển</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-bold" href="#">Cẩm Nang Công Việc</a>
                            </li>
