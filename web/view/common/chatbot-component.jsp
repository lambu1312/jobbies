...
<div class="chatbot-container" id="chatContainer">
    ...
    <div class="chatbot-messages" id="messages">
        <div class="message bot">
            <div class="message-content initial-message">Xin chào! 👋 Tôi là trợ lý AI của Jobbies. Tôi có thể giúp gì cho bạn?</div>
        </div>
    </div>
...
<style>
    ...
    .message.bot .message-content.initial-message {
        white-space: normal;
    }
