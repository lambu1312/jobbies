<footer class="rts__section footer__home__one" style="background-color: #495057; color: #f8f9fa; border-top: 5px solid #6f42c1;">
    <div class="container">
        <div class="row">
    ...
    <div class="rts__copyright" style="background-color: #6c757d; border-top: 1px solid #6f42c1">
        <div class="container">
...
<style>
    ...
    .rts__section.footer__home__one {
        ...
        color: #f8f9fa;
        /* ?ã s?a: Màu vi?n trên chuy?n sang màu Tím (#6f42c1) */
    ...
    .footer__link:hover {
        /* ?ã s?a: Màu khi di chu?t vào chuy?n sang màu Tím (#6f42c1) */
        color: #6f42c1;
