    ...
    <div class="modern-sidebar" style="width: 280px; position: fixed; top: 0; left: 0; height: 100vh; z-index: 1000;">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/candidates" class="nav-link">
                        ...
                        <span class="nav-text">Seeker Management</span>
                    </a>
                </li>
                <li>
            ...
            <div class="dropdown user-dropdown">
                <a href="#" class="user-profile dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown"
                    aria-expanded="false">
                ...
                <ul class="dropdown-menu shadow" aria-labelledby="dropdownUser1">
                    ...
                    <li>
                        <a class="dropdown-item"
                            href="${pageContext.request.contextPath}/authen?action=change-password">
                    ...
                    <li>
                        <a class="dropdown-item logout-item"
                            href="${pageContext.request.contextPath}/view/authen/logout.jsp">
