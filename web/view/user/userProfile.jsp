        ...
        <jsp:include page="../common/user/header-user.jsp"></jsp:include>
            ...
            <div class="container mt-5 mb-5">
                ...
                <c:if test="${jobSeeker != null}">
                    <div>
                        <span class="badge custom-badge bg-success">Your Candidate ID: #${jobSeeker.getCandidateID()}</span>
                    </div>
                ...
                <c:if test="${jobSeeker == null}">
                    <div>
                        ...
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalJoinCandidate">
                            Join Job Seeker
                        </button>
                    </div>
                </c:if>
                ...
                <c:if test="${not empty errorCandidate}">
                    <div style="color: red;">
                        ${error}
                    </div>
                </c:if>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <c:set var="isCandidate" value="${not empty jobSeekerInfo}" />
            ...
            <!--Modal-->
            <div class="modal fade" id="modalJoinCandidate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
