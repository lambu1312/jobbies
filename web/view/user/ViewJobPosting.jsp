                                    ...
                                    <div class="job-detail-wrapper">
                                        ...
                                        <div class="job-main">
                                                ...
                                                <div class="job-meta">
                                                    ...
                                                    <div class="meta-item">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="meta-value">$${jobPost.minSalary} -
                                            ...
                                            <div class="card">
                                                ...
                                                <form
                                                    action="${pageContext.request.contextPath}/feedbackSeeker?action=create"
                                                    method="post" class="feedback-form">
                                                    <input type="hidden" name="jobPostingID"
                                                        value="${jobPost.jobPostingID}">
                                            ...
                                            <div class="card action-card">
                                                ...
                                                <c:choose>
                                                    <c:when test="${empty existFavourJP}">
                                                        <form
                                                            action="${pageContext.request.contextPath}/jobPostingDetail?action=add-favourJP"
                                                            method="post">
                                                            <input type="hidden" name="jobPostingIDF"
                                                                value="${jobPost.jobPostingID}">
                                                            <c:if test="${not empty jobSeekerF}">
                                                                <input type="hidden" name="jobSeekerIDF"
                                                                    value="${jobSeekerF.jobSeekerID}">
                                                            </c:if>
                                                ...
                                                <c:choose>
                                                    <c:when test="${empty existingApplication}">
                                                        <c:if test="${not empty isOpenJP}">
                                                            <form
                                                                action="${pageContext.request.contextPath}/jobPostingDetail?action=add-application"
                                                                method="post">
                                                                <input type="hidden" name="jobPostingID"
                                                                    value="${jobPost.jobPostingID}">
                                                                <c:if test="${not empty jobSeeker}">
                                                                    <input type="hidden" name="jobSeekerID"
                                                                        value="${jobSeeker.jobSeekerID}">
                                                                </c:if>
            ...
            <div class="container my-5">
                <c:if test="${not empty jobPost}">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <!-- Feedback Form -->
                            <form action="${pageContext.request.contextPath}/feedbackSeeker?action=create"
                                method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="feedbackContent" name="content" rows="3"
                                            required placeholder="Enter your feedback here..."></textarea>
                                    </div>
                                </div>
