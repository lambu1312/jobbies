...
<body>
    <!-- Side Banners -->
    <a href="https://www.momo.vn/" target="_blank" class="side-banner banner-left">
        <div class="momo-banner">
            ...
            <div class="momo-cta">Tải ngay</div>
        </div>
    </a>

    <a href="https://www.netflix.com/vn/" target="_blank" class="side-banner banner-right">
        <div class="netflix-banner">
            ...
            <div class="netflix-cta">Xem ngay</div>
        </div>
    </a>
