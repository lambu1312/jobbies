<%-- Document : recruiterManagement Created on : Sep 15, 2024, 4:26:38 PM Author : Admin --%>
                                ...
                                <head>
                                    ...
                                    <style>
                                        .recruiter-status.active {
                                            color: green;
                                            /* Active recruiters in green */
                                            font-weight: bold;
                                        }

                                        .recruiter-status.inactive {
                                            color: red;
                                            /* Inactive recruiters in red */
                                            font-weight: bold;
                                        }
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <!--end-->
                                                <h6 class="fw-medium mb-30 text-center fs-2">RECRUITER ACCOUNT
                                                    MANAGEMENT</h6>
                                                <div class="container-fluid"
                                                    ...
                                                    <div class="dash__content">
                                                        ...
                                                        <div class="sidebar__menu d-md-block d-lg-none">
                                                            <div class="sidebar__action"><i
                                                                    class="fa-sharp fa-regular fa-bars"></i> Sidebar
                                                            </div>
                                                        </div>
                                                        <!-- sidebar menu end -->
                                                        <div
                                                            class="d-flex justify-content-between align-items-center mb-3 ms-2">
                                                            <!--drop-down filter recruiter-->
                                                            <div class="filter-dropdown">
                                                                <form
                                                                    action="${pageContext.request.contextPath}/recruiters"
                                                                    method="GET">
                                                                    <label for="recruiter-filter">Filter </label>
                                                                    <select id="recruiter-filter" name="filter"
                                                                        onchange="this.form.submit()">
                                                                        <option value="all" ${param.filter==null ||
                                                                            param.filter=='all' ? 'selected' : '' }>All
                                                                            Recruiters</option>
                                                                        <option value="active" ${param.filter=='active'
                                                                            ? 'selected' : '' }>Active Recruiters
                                                                        </option>
                                                                        <option value="inactive"
                                                                            ${param.filter=='inactive' ? 'selected' : ''
                                                                            }>Inactive Recruiters</option>
                                                                    </select>
                                                                </form>
                                                            </div>
                                                        ...
                                                        <hr />
                                                        <!--search recruiter-->
                                                        <form action="${pageContext.request.contextPath}/recruiters"
                                                            method="GET">
                                                            <div class="d-flex justify-content-center mb-3">
                                                                ...
                                                                <input type="text" id="searchRecruiter"
                                                                    name="searchQuery" class="form-control"
                                                                    style="width: 60%;"
                                                        ...
                                                        <div class="recruiter-list">
                                                            <table class="table table-bordered"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <% // Tạo một đối tượng CompanyDAO CompanyDAO
                                                                        companyDao=new CompanyDAO(); // Tao mot doi
                                                                        tuong Recruiter RecruitersDAO recruitersDao=new
                                                                        RecruitersDAO(); %>
                                                                        <c:forEach items="${listRecruiters}"
                                                                            var="recruiter">
                                                                            <c:set var="recruiterId"
                                                                                value="${recruiter.getId()}" />
                                                                            <tr>
                                                                                <!-- Avatar Column -->
                                                                                <td>
                                                                                    <c:if
                                                                                        test="${empty recruiter.getAvatar()}">
                                                                                    ...
                                                                                    <c:if
                                                                                        test="${not empty recruiter.getAvatar()}">
                                                                                        <img src="${recruiter.getAvatar()}"
                                                                                            alt="Avatar"
                                                                                            class="seeker-avatar"
                                                                                            style="width: 50px; height: 50px; border-radius: 50%;">
                                                                                    </c:if>
                                                                                ...
                                                                                <!--Company Name Column-->
                                                                                <td>
                                                                                    <% int recruiterAccountId=(Integer)
                                                                                        pageContext.getAttribute("recruiterId");
                                                                                        List<Company> companies =
                                                                                        companyDao.getCompanyNameByAccountId(recruiterAccountId);
                                                                                        String companyName = "";
                                                                                        String statusClassCom = "";
                                                                                        if (companies != null &&
                                                                                        !companies.isEmpty()) {
                                                                                        companyName =
                                                                                        companies.get(0).getName(); //
                                                                                        Lấy tên công ty từ danh sách
                                                                                        }else{
                                                                                        companyName = "Not yet
                                                                                        registered";
                                                                                        statusClassCom =
                                                                                ...
                                                                                <td>
                                                                                    <% Recruiters
                                                                                        recruiters=recruitersDao.findRecruitersbyAccountID(String.valueOf(recruiterAccountId));
                                                                                        String verification="" ; String
                                                                                        statusClass="" ; if(recruiters
                                                                                        !=null){
                                                                                        verification=recruiters.isIsVerify()==true
                                                                                        ? "Approved" : "Pending" ;
                                                                                        statusClass=recruiters.isIsVerify()==true
                                                                                        ? "status-approved"
                                                                                        : "status-pending" ; }else{
                                                                                        verification="None" ;
                                                                                ...
                                                                                <td>
                                                                                    <div class="form-check form-switch">
                                                                                        <input class="form-check-input"
                                                                                            type="checkbox"
                                                                                            role="switch"
                                                                                            id="flexSwitchCheck${recruiter.id}"
                                                                                            ${recruiter.isActive
                                                                                            ? 'checked' : '' }
                                                                                            data-recruiter-id="${recruiter.id}">
                                                                                        <label class="form-check-label"
                                                                                            for="flexSwitchCheck${recruiter.id}"></label>
                                                                                    </div>
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    <form
                                                                                        action="recruiters?action=view-detail"
                                                                                        method="POST">
                                                                                        <input type="hidden"
                                                                                            name="id-recruiter"
                                                                                            value="${recruiter.getId()}">
                                                            ...
                                                            <nav aria-label="Page navigation">
                                                                <ul class="pagination justify-content-center"
                                                                    ...
                                                                    <c:if
                                                                        test="${endPage < pageControl.getTotalPages()}">
                                                                        <li class="page-item">
                                                                            <a class="page-link"
                                                                    ...
                                                                    <c:if
                                                                        test="${pageControl.getPage() < pageControl.getTotalPages()}">
                                                                        <li class="page-item">
                                                                            <a class="page-link"
                                                                                href="${pageControl.getUrlPattern()}page=${pageControl.getPage() + 1}"
                                                                                aria-label="Next">
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas"
                                        ...
                                        <div class="offcanvas-header p-0 mb-5 mt-4">
                                            <a href="index.html" class="offcanvas-title" id="offcanvasLabel">
                                                <img src="${pageContext.request.contextPath}/assets/img/logo/header__one.svg"
                                                    alt="logo">
                                            </a>
                                        ...
                                        <div class="offcanvas-body p-0">
                                            ...
                                            <p
                                                class="max-auto font-20 fw-medium text-center text-decoration-underline mt-4">
                                                Our Social Links</p>
