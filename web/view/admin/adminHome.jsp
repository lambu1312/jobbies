                                    ...
                                    <%@page import="dao.AccountDAO" %>
                                        ...
                                        <head>
                                            ...
                                            <style>
                                                ...
                                                .dashboard-card h3 {
                                                    font-size: 1.25rem;
                                                    /* Giảm kích thước chữ của tiêu đề */
                                                    margin-bottom: 5px;
                                                }

                                                .dashboard-card p {
                                                    font-size: 1rem;
                                                    /* Giảm kích thước chữ của nội dung */
                                                    margin: 0;
                                                }

                                                .dashboard-card i {
                                                    font-size: 1.5rem;
                                                    /* Giảm kích thước của icon */
                                                    margin-bottom: 5px;
                                                }
                                                ...
                                                .chart-title-green {
                                                    ...
                                                    font-weight: bold;
                                                    margin: 0;
                                                    /* Loại bỏ khoảng trống trên và dưới */
                                                ...
                                                .chart-container {
                                                    ...
                                                    margin-top: 0;
                                                    /* Loại bỏ khoảng cách phía trên */
                                                }

                                                .chart-container .card-body {
                                                    padding: 0;
                                                    /* Loại bỏ padding mặc định trong thẻ card-body */
                                                }
                                            </style>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4 mb-4">
                                                                            <div class="dashboard-card bg-seekers">
                                                                                <i
                                                                                    class="fas fa-user fa-2x text-white mb-2"></i>
                                                                                <h3>Total Seekers</h3>
                                                                                <p id="total-seekers">${totalSeeker}</p>
                                                                                <p class="text-white">Active: <span
                                                                                        id="active-seekers">${totalSeekerActive}</span>
                                                                                </p>
                                                                                <p class="text-white">Inactive: <span
                                                                                        id="inactive-seekers">${totalSeekerInactive}</span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-4 mb-4">
                                                                            <div class="dashboard-card bg-recruiters">
                                                                                <i
                                                                                    class="fas fa-user-tie fa-2x text-white mb-2"></i>
                                                                                <h3>Total Recruiters</h3>
                                                                                <p id="total-recruiters">
                                                                                    ${totalRecruiter}</p>
                                                                                <p class="text-white">Active: <span
                                                                                        id="active-recruiters">${totalRecruiterActive}</span>
                                                                                </p>
                                                                                <p class="text-white">Inactive: <span
                                                                                        id="inactive-recruiters">${totalRecruiterInactive}</span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-4 mb-4">
                                                                            <div class="dashboard-card bg-companies">
                                                                                <i
                                                                                    class="fas fa-building fa-2x text-white mb-2"></i>
                                                                                <h3>Total Companies</h3>
                                                                                <p id="total-companies">${totalCompany}
                                                                                </p>
                                                                                <p class="text-white">Active: <span
                                                                                        id="active-companies">${totalCompanyActive}</span>
                                                                                </p>
                                                                                <p class="text-white">Inactive: <span
                                                                                        id="inactive-companies">${totalCompanyInactive}</span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="card chart-container">
                                                                    <h4 class="chart-title-green">Top 5 Employers with
                                                                        the Most Posts Chart</h4>
                                                                    <div class="card-body">
                                                                        <canvas
                                                                            id="jobPostingTopRecruitersChart"></canvas>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <!-- Phần không gian cho biểu đồ hình tròn -->
                                                                <div class="card chart-container">
                                                                    <h4 class="chart-title-green">Job Posting Status
                                                                        Chart</h4>
                                                                    <div class="card-body">
