                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="dashboard-card bg-seekers">
                                            ...
                                            <h3>Tổng số người tìm việc</h3>
                                            <p id="total-seekers">${totalSeeker}</p>
                                            <p class="text-white">Hoạt động: <span id="active-seekers">${totalSeekerActive}</span></p>
                                            <p class="text-white">Không hoạt động: <span id="inactive-seekers">${totalSeekerInactive}</span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="dashboard-card bg-recruiters">
                                            ...
                                            <p class="text-white">Hoạt động: <span id="active-recruiters">${totalRecruiterActive}</span></p>
                                            <p class="text-white">Không hoạt động: <span id="inactive-recruiters">${totalRecruiterInactive}</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card chart-container">
                                    <h4 class="chart-title-purple">Biểu đồ Top 5 nhà tuyển dụng có nhiều bài đăng nhất</h4>
                                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="card chart-container">
                                    <h4 class="chart-title-green">Biểu đồ trạng thái bài đăng tuyển</h4>
                                    <div class="card-body">
                                                    ...
                                                    new Chart(ctxJobPostingStatus, {
                                                        ...
                                                        options: {
                                                            ...
                                                            plugins: {
                                                                ...
                                                                title: {
                                                                    display: true,
                                                                    text: 'Trạng thái bài đăng tuyển'
                                                                },
                                                                datalabels: {
                                                                    color: '#fff',
                                                                    formatter: (value, ctx) => {
