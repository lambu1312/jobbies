                    ...
                    <form class="p-4 rounded shadow-sm bg-light">
                                ...
                                <c:if test="${requestScope.accountView.getRoleId() == 3}">
                                    <div class="mt-3">
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#educationModal">
                                            <i class="fas fa-graduation-cap me-2"></i>Detail Education
                                        </button>
                                    </div>
                                    <div class="mt-2">
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#experienceModal">
                                            <i class="fas fa-briefcase me-2"></i>Detail Experience
                                        </button>
                                    </div>
                                </c:if>
                            </div>
                            ...
                            <div class="w-100">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" id="lastName" class="form-control" readonly value="${requestScope.accountView.lastName}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="firstName" class="form-label">First Name</label>
                                        <input type="text" id="firstName" class="form-control" readonly value="${requestScope.accountView.firstName}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" id="phone" class="form-control" readonly value="${requestScope.accountView.phone}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="dob" class="form-label">Date of Birth</label>
                                        <input type="date" id="dob" class="form-control" readonly value="${requestScope.accountView.dob}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" id="address" class="form-control" readonly value="${requestScope.accountView.address}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" id="email" class="form-control" readonly value="${requestScope.accountView.email}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="createAt" class="form-label">Create At</label>
                                        <input type="text" id="createAt" class="form-control" readonly value="${requestScope.accountView.createAt}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <c:if test="${requestScope.accountView.roleId == 3}">
                                <button type="button" class="btn btn-info" onclick="location.href = '${pageContext.request.contextPath}/candidates'">
                                    <i class="fas fa-arrow-left me-2"></i>Back
                                </button>
                            </c:if>
                            <c:if test="${requestScope.accountView.roleId == 2}">
                                <button type="button" class="btn btn-info" onclick="location.href = '${pageContext.request.contextPath}/recruiters'">
                                    <i class="fas fa-arrow-left me-2"></i>Back
                                </button>
                            </c:if>
                        </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="experienceModalLabel">
                                    <i class="fas fa-briefcase me-2"></i>Experience Details
                                </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
