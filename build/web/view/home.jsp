                    ...
                    <form action="${pageContext.request.contextPath}/home" method="GET" id="filterForm">
                        <div class="filter-grid">
                            ...
                            <div>
                                ...
                                <div class="salary-inputs-wrapper">
                                    <input type="number" 
                                           name="minSalary" 
                                           id="minSalary" 
                                           class="form-control" 
        ...
        <script>
            ...
            (function () {
                ...
                function isDateRangeValid() {
                    ...
                    // Nếu 1 trong 2 rỗng -> không bắt lỗi
                    if (!from || !to) {
                        showDateError(false);
                        return true;
                    }

                    // input type="date" trả yyyy-MM-dd nên so sánh string được luôn
                    if (from > to) {
                        showDateError(true);
                        return false;
                    }
                ...
                // realtime: đổi ngày là ẩn/hiện lỗi luôn
                if (dateFromEl)
                    dateFromEl.addEventListener("change", isDateRangeValid);
                if (dateToEl)
                    dateToEl.addEventListener("change", isDateRangeValid);
            })();
        </script>
