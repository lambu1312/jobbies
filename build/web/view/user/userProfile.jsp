<%-- Document : userProfile Created on : Sep 18, 2024, 5:20:27 PM Author : Admin --%>
...
<html lang="en">
    ...
    <head>
        ...
        <style>
            .custom-badge {
                ...
                padding: 10px 20px;
                /* Adds padding for a bigger badge */
                margin-top: 10px;
                /* Adds some spacing around the badge */
                border-radius: 8px;
                /* Optional: rounds the badge corners */
            }
        </style>
    ...
    <body class="template-dashboard">
        ...
        <jsp:include page="../common/user/header-user.jsp"></jsp:include>
            ...
            <c:if test="${jobSeeker == null}">
                -->                <div>
                    <h2>Bạn chưa là thành viên của Jobbies ?</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-3 sidebar p-3">
                    <h5 class="text-center text-dark">Danh Sách Người Dùng</h5>
                    <ul class="nav nav-tabs flex-column" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="deactivate-account-tab" data-bs-toggle="tab"
                               href="#deactivate-account" role="tab" aria-controls="deactivate-account"
                               aria-selected="false">Vô hiệu hóa tài khoản</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <form class="p-4 rounded shadow-sm bg-light">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="dob" class="form-control" required
                                                   readonly value="${sessionScope.account.dob}">
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="email" class="form-control"
                                           placeholder="jobpath@gmail.com" required readonly
                                           value="${sessionScope.account.email}">
                                </div>
                                <div class="mb-3">
                                    <label for="phone" class="form-label">Số Điện Thoại</label>
                                    <input type="text" id="phone" class="form-control" placeholder="+84"
                                           required readonly value="${sessionScope.account.phone}">
                                </div>

                                <div class="mb-3">
                                    <label for="gender" class="form-label">Giới Tính</label>
                                    <input type="text" id="genderDisplay" class="form-control"
                                           value="${sessionScope.account.gender == true ? 'Male' : 'Female'}"
                                           readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="add" class="form-control"
                                           placeholder="Your Address" required readonly
                                           value="${sessionScope.account.address}">
                                </div>
                                <button type="button" class="btn btn-info" id="editProfile"
                                        onclick="location.href = '${pageContext.request.contextPath}/authen?action=edit-profile'">Sửa
                                    Hồ Sơ</button>
                            </form>
                        </div>

                        <!-- Deactivate Account Tab -->
                        <div class="tab-pane fade" id="deactivate-account" role="tabpanel"
                             aria-labelledby="deactivate-account-tab">
                            <h6>Vô hiệu hóa tài khoản của bạn</h6>
                            ...
                            <form
                                action="${pageContext.request.contextPath}/authen?action=deactivate-account"
                                method="POST">
                                <div class="mb-3">
                                    <label for="currentPassword" class="form-label">Vui lòng nhập thông tin của bạn.
                                        Mật khẩu đăng nhập</label>
                                    <div class="input-group">
                                        <input type="password" class="form-control" id="currentPassword"
                                               name="currentPassword" placeholder="Enter your password"
                                               required onkeydown="preventSpaces(event)">
                                ...
                                <p class="text-danger">
                                    <strong>Lưu ý:</strong> Sau khi tài khoản của bạn bị vô hiệu hóa, bạn sẽ
                                    tạm thời không thể sử dụng tài khoản đó. Nếu bạn muốn kích hoạt lại tài khoản của mình,
            ...
            <!--Modal-->
            <div class="modal fade" id="modalJoinJobSeeker" tabindex="-1"
                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Tham gia tìm việc</h1>
                        ...
                        <c:if test="${!empty requestScope.joinsuccess}">
                            ...
                            <div class="modal-footer">
                                <a href="${pageContext.request.contextPath}/view/user/userHome.jsp"
                                   class="btn btn-success">Trở Về Trang Chủ</a>
                            </div>
                        </c:if>
                        ...
                        <c:if test="${empty requestScope.joinsuccess}">
                            ...
                            <div class="modal-body">
                                <h5>Bạn có chắc chắn muốn tham gia tìm việc không?</h5>
                            </div>
                            <form id="confirmForm"
                                  action="${pageContext.request.contextPath}/seeker?action=join-job-seeking"
            ...
            <button type="button" class="btn btn-primary position-fixed" id="back-to-top"
