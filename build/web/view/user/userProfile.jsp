                                    ...
                                    <ul class="nav nav-tabs flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="deactivate-account-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false">Deactivate Account</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade show active" id="profile" role="tabpanel"
                                            ...
                                            <form class="p-4 rounded shadow-sm bg-light">
                                                ...
                                                <button type="button" class="btn btn-info" id="editProfile"
                                                    onclick="location.href = '${pageContext.request.contextPath}/authen?action=edit-profile'">Edit
                                                    Profile</button>
                                            </form>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="deactivate-account" role="tabpanel"
                                            ...
                                            <form
                                                ...
                                                method="POST">
                                                <div class="mb-3">
                                                    <label for="currentPassword" class="form-label">Please Enter Your
                                                ...
                                                <p class="text-danger">
                                                    <strong>Note:</strong> After your account is deactivated, you will
                                                    temporarily be unable to use it. If you wish to reactivate your
                                                    account, please contact the Admin for assistance.
                                                </p>
                                        ...
                                        <c:if test="${!empty requestScope.joinsuccess}">
                                            ...
                                            <div class="modal-footer">
                                                <a href="${pageContext.request.contextPath}/view/user/userHome.jsp"
                                                    class="btn btn-success">Go to Home</a>
                                            </div>
                                        </c:if>
