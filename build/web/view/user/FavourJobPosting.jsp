...
<body>
    ...
    <div class="container">
        <h1 class="page-title">My Favourite Job Postings 💖</h1>
            ...
            <c:when test="${not empty favourJPs}">
                                ...
                                <div class="modal" id="deleteFavourJPModal-${fjp.favourJPID}">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <button type="button" class="modal-close" onclick="closeModal('deleteFavourJPModal-${fjp.favourJPID}')">
                                        ...
                                        <form action="${pageContext.request.contextPath}/FavourJobPosting" method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" onclick="closeModal('deleteFavourJPModal-${fjp.favourJPID}')">
                                                    Cancel
                                                </button>
                ...
                <nav class="pagination">
                    <c:if test="${currentPage > 1}">
                        <a href="${pageContext.request.contextPath}/FavourJobPosting?page=${currentPage - 1}" class="page-button">
                            « Previous
                        </a>
                    </c:if>
